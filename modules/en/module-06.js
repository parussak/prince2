...
window.MODULE_DATA[6] = {
  ...
  "storyQuiz": [
    {
      ...
      "correct": 1,
      "explanation": "The Executive represents the business and is the single point of accountability for the project. It is determined by business; this accountability CANNOT be delegated."
    },
    {
      "question": "2. Maya represents players and ensures that the game controls are intuitive. What is her role on the Project Board?",
      "options": [
        "Senior User",
        "Senior Supplier",
        "Project Support",
      ...
      "correct": 0,
      "explanation": "The lead user(s) represents the user community and is accountable for the approach to capturing user requirements and benefit specifications aligned with the business case."
    },
    {
      "question": "3. Kamil manages an external company. providing the graphics engine. Responsible for the quality of suppliers' code. Who is on the Board?",
      "options": [
        "Senior Supplier",
        "Senior User",
        "Project Manager",
    ...
    {
      "question": "4. Zosia has too much work creating reports. Appoints a person to keep archives and registers. What is this support role called?",
      "options": [
        "Project Assurance",
        "Project Support",
        "Team Manager",
      ...
      "correct": 1,
      "explanation": "Project Support helps PMs with administration, records and tools."
    },
    {
      "question": "5. Artur asks if he can combine the role of Executive and Project Manager to 'save on full-time employment'. What does Zosia say?",
      "options": [
        "Yes, PRINCE2 allows this.",
        "NO! The roles of Executive and Project Manager (PM) CANNOT be combined into one person.",
        "Yes, provided the team agrees.",
        "It depends on your budget."
      ],
      "correct": 1,
      "explanation": "The Project Manager CANNOT be a member of the Project Board or act as an Executive. The Levels of Management and Direction must be separated."
    },
    {
      "question": "6. Who is responsible for independently checking for the Project Board whether the work is carried out properly (Project Assurance - Project Assurance)?",
      "options": [
        "Members of the Project Board (or independent persons designated by them).",
        "Project Manager (PM).",
        "Programmers and graphic designers.",
        "External tax office."
      ],
      "correct": 0,
      "explanation": "Board members are accountable for the oversight of their areas. They may appoint separate people for oversight tasks, but not PMs, team members or Project Support."
    },
    {
      "type": "standard",
      "question": "7. Artur wants to give Zosia responsibility for the project while remaining Executive. Can he do it?",
      "options": [
        "Yes, if I put it in the role description.",
        "Yes, for one stage.",
        "No - Executive accountability for the project cannot be delegated.",
        "Yes, if Maya agrees."
      ],
      "correct": 2,
    ...
    {
      "type": "standard",
      "question": "8. Maya describes the benefits of SnakeBite. What should they be matched with?",
      "options": [
        "Only with graphic designer preferences.",
        "With business justification.",
        "Only with Tomek's schedule.",
        "With a list of Project Support tools."
      ],
      "correct": 1,
      "explanation": "The Senior User is accountable for the approach to capturing user requirements and benefit specifications aligned with the business case."
    },
    {
      "type": "standard",
      "question": "9. The engine works independently, but does not cooperate with the rest of the game. For which area is Kamil also responsible as a Senior Supplier?",
      "options": [
        "For appointing Executive.",
        "For the administration of all registers.",
        "For the technical integrity of the project.",
        "For self-approving the business case."
      ],
      "correct": 2,
      "explanation": "The quality of supplier products does not exhaust the Senior Supplier role: it also covers the technical integrity of the project."
    },
    {
      "type": "standard",
    ...
    {
      "type": "standard",
      "question": "11. Zosia and Tomek agree on when changes can be made at an internal meeting. Do such arrangements need to be secured?",
      "options": [
        "No, because Tomek is not an external supplier.",
        "No, if no contract has been signed.",
        "Yes, but only costs arrangements.",
        "Yes - also informal arrangements with colleagues."
      ],
      "correct": 3,
      "explanation": "The Project Manager secures ALL project arrangements, both formal contracts and informal internal arrangements."
    },
    {
      "type": "standard",
      "question": "12. The Board wants to entrust the supervision of the project to the person keeping the registers as Project Support. Is this appropriate?",
      "options": [
        "No - Project Support cannot perform Project Assurance.",
        "Yes, because he knows the registers.",
        "Yes, if Zosia has no objections.",
        "Yes, if it is done outside working hours."
      ],
      "correct": 0,
      "explanation": "Project supervision cannot be delegated to the Project Manager, team members or Project Support."
    },
    {
      "type": "standard",
      "question": "13. PixelBite Games has not designated a separate person to support the project. Who is responsible for these tasks by default?",
      "options": [
        "Kamil as Senior Supplier.",
        "Zosia as Project Manager.",
        "Only Arthur.",
        "Nobody until a project office is established."
      ],
      "correct": 1,
      "explanation": "Project support remains the responsibility of the Project Manager by default; may be delegated or established as a project office."
    },
    {
      "type": "standard",
      "question": "14. Zosia keeps track of costs and deadlines. Which set covers all 7 areas he manages?",
      "options": [
        "Costs, time, marketing, sales, law, HR, purchasing.",
        "Benefits, costs, time, risk, quality, scope, sustainability.",
        "Budget, programming, testing, graphics, sound, advertising, recruitment.",
        "Only scope, time and costs."
      ],
      "correct": 1,
      "explanation": "The project manager manages seven areas, including benefits and sustainability, within agreed tolerances and constraints."
    }
  ],
  "examQuiz": [
    {
      "type": "standard",
      "question": "Which three interests MUST be represented on the Project Board?",
      "options": [
        "Finance, Law, Marketing",
        "Business (Executive), Users (Senior User), Suppliers (Senior Supplier)",
        "Project Manager, Programmer, Tester",
        "Sponsor, HR Director, Trade Unions"
      ],
      "correct": 1,
      "explanation": "The Project Board always represents three key interests: Business, Users and Suppliers."
    },
    {
      "type": "missing-word",
      "question": "The person who is the single point of accountability for the project is the project [...].",
      "options": [
        "Executive",
        "Manager",
        "Supplier",
    ...
    {
      "type": "negative",
      "question": "Which of the following statements about Project Assurance is NOT true?",
      "options": [
        "This is an obligation belonging to the members of the Project Board.",
        "It may be performed by independent persons delegated by the Board.",
        "The project manager can perform project assurance for the project board.",
        "Checks the correctness of work on behalf of the interests of the Business, Users and Suppliers."
      ],
      "correct": 2,
      "explanation": "The Project Manager may NEVER perform the Project Assurance function - this would be a conflict of interest (self-monitoring)."
    },
    {
      "type": "standard",
      "question": "What is the main goal of the Team Manager role?",
      "options": [
        "Approval of the budget for the entire project.",
        "Ensuring the production of products specified in Work Packages and reporting to PM.",
        "Negotiating contracts with the Sponsor.",
        "Closing the Initiation Stage."
      ],
      "correct": 1,
      "explanation": "The Team Manager is responsible for the operational management of the executive team and the delivery of work packages."
    },
    {
      "type": "missing-word",
      "question": "The role supporting the project manager with administrative services is project [...].",
      "options": [
        "Support",
        "Assurance",
        "Executive",
    ...
    {
      "type": "standard",
      "question": "What is the goal of the Organization practice?",
      "options": [
        "Only preparation of the work schedule.",
        "Defining and establishing a project accountability and responsibility structure (who).",
        "Product technology selection.",
        "Replacing the business case with team structure."
      ],
      "correct": 1,
      "explanation": "The purpose of the Organization practice is to define and establish a project accountability and responsibility structure (who)."
    },
    {
      "type": "missing-word",
      "question": "The project management level between the business layer and the project manager is [...].",
      "options": [
        "Directing (the project board)",
        "Delivering (the team manager)",
        "Starting (the executive)",
        "Assuring (the project support)"
      ],
      "correct": 0,
    ...
    {
      "type": "standard",
      "question": "What is the Senior User(s) accountable for?",
      "options": [
        "For the approach to capturing user requirements and benefit specifications aligned with the business case.",
        "For the quality of suppliers' products and the technical integrity of the project.",
        "For appointing an Executive.",
        "For setting the project tolerance yourself."
      ],
      "correct": 0,
      "explanation": "The Senior User represents the user community and is responsible for the indicated approach to requirements and benefits."
    },
    {
      "type": "missing-word",
      "question": "Complete: in addition to the quality of the suppliers' products, the Senior Supplier is responsible for [...] the project.",
      "options": [
        "advertising",
        "technical integrity",
        "job",
        "one-person financing"
      ],
      "correct": 1,
    ...
    {
      "type": "standard",
      "question": "Which description corresponds to the \"User\" interest page?",
      "options": [
        "Only the person purchasing the product.",
        "Only the person who approves the budget.",
        "Exclusive provider of specialist resources.",
        "People who use, operate, maintain or support the results and those who are affected by the results."
      ],
      "correct": 3,
      "explanation": "The user perspective also includes maintaining and supporting results and the impact of results on users."
    },
    {
      "type": "missing-word",
      "question": "The project manager assigns specialist work to the team manager through a work package [...].",
      "options": [
        "Description",
        "Report",
        "Register",
    ...
    {
      "type": "standard",
      "question": "Which layer commissions the project and provides its initial mandate?",
      "options": [
        "Business layer",
        "Team manager",
        "Project support",
    ...
    {
      "type": "missing-word",
      "question": "Complete: The value for money side of the business is represented by [...].",
      "options": [
        "Team Manager",
        "ProjectSupport",
        "Executive",
  ...
  "flashcards": [
    {
      "q": "List the 4 levels of management in PRINCE2.",
      "a": "Project commissioning (business layer) → Orientation (project board) → Management (project manager) → Delivery (team managers)."
    },
    {
      "q": "Who constitutes the Project Board?",
      "a": "Executive, Senior User (Senior User), Senior Supplier (Senior Supplier)."
    },
    {
    ...
    },
    {
      ...
      "a": "He cannot be a member of the Project Board (including the Executive) or perform Project Assurance."
    },
    {
      "q": "What does Project Assurance do?",
      "a": "Independent monitoring of work on behalf of the Project Board (business, users, suppliers)."
    },
    {
      "q": "What does Project Support do?",
      "a": "Administration, record keeping and PM tool support."
    },
    {
      "q": "What is the name of the role responsible for delivering the Work Package?",
      "a": "Team Manager."
    },
    {
      "q": "Can the Project Board have only one member?",
      "a": "Yes, if the Executive also takes on the roles of Senior User and Senior Supplier."
    },
    {
      "q": "What is the goal of the Organization practice?",
      "a": "The purpose of the Organization practice is to define and establish a project accountability and responsibility structure (who)."
    },
    {
      "q": "What is the business layer preparing?",
      "a": "Commissioning the project to complete it with an outline that the project board agrees to."
    },
    {
      "q": "Who appoints the Executive and can his or her accountability be delegated?",
      "a": "It is determined by business. It is a single point of accountability for the project; this accountability CANNOT be delegated."
    },
    {
      "q": "What approach is the Senior User accountable for?",
      "a": "For the approach to capturing user requirements and benefit specifications aligned with the business case."
    },
    {
      "q": "What two areas is the Senior Supplier responsible for?",
      "a": "For the quality of products delivered by suppliers and the technical integrity of the project."
    },
    {
      "q": "List the 7 management areas of a project manager.",
      "a": "Benefits, costs, time, risk, quality, scope, sustainability."
    },
    {
      "q": "On whose behalf does the Project Manager act and within what limits?",
      "a": "On behalf of the Project Board, within agreed tolerances and limits."
    },
    {
      "q": "How does the PM assign work to the Team Manager?",
      "a": "In the form of a description of the Work Package, in accordance with the Commercial Management Approach."
    },
    {
      "q": "Does securing arrangements only apply to formal contracts?",
      "a": "NO. PM secures ALL arrangements: formal contracts with external suppliers and informal arrangements with colleagues, such as when and how changes are made."
    },
    {
      "q": "Who MUST NOT be entrusted with Project Assurance?",
      "a": "The project manager, team members or project support."
    },
    {
      "q": "Does appointing people to Project Oversight transfer the accountability of the Board?",
      "a": "NO. Board members remain accountable for the oversight of their areas."
    },
    {
      "q": "Who is responsible for Project Support by default?",
      "a": "Project Manager. Can delegate this responsibility; Project support can be established as a project office."
    },
    {
      "q": "What needs does Business represent?",
      "a": "Meeting business needs and providing value for money. Representative: Executive."
    },
    {
      "q": "Who is covered by the User side of interest?",
      "a": "People who use, operate, maintain or support the results, and those who are affected by the results. Representative: Senior User."
    },
    {
      "q": "What does the Supplier's side of interest bring?",
      "a": "Resources with specific skills needed to produce products. Representative: Senior Supplier."
    },
    {
      "q": "What work limits apply to the Team Manager?",
      "a": "Agreed specifications and tolerances agreed with the Project Manager."
    }
  ]
};

...
window.MODULE_DATA[13] = {
  ...
  "storyQuiz": [
    {
      ...
      "correct": 1,
      "explanation": "Starting up a project (SU) to proces przedprojektowy chroniący firmę przed wchodzeniem w bezsensowne inicjatywy."
    },
    {
      "question": "2. Podczas procesu SU Zosia i Artur tworzą krótki dokument syntezujący cel gry, szacowane koszty i role. Jak nazywa się ten dokument?",
      "options": [
        "Dokumentacja Inicjująca Projekt (PID)",
        "Zarys Projektu (Project Brief)",
        "Plan Etapu 2",
        "Rejestr Jakości"
      ],
      "correct": 1,
      "explanation": "Project Brief (Zarys Projektu) to kluczowy produkt procesu SU, stanowiący podstawę do decyzji o przejściu do IP."
    },
    {
      "question": "3. Rada Projektu daje zgodę na etap inicjowania. Zosia wchodzi w proces Initiating a project (IP). Co jest jej głównym zadaniem?",
      "options": [
        "Napisanie całego kodu gry.",
        "Opracowanie PID, w tym doprecyzowanie Business Case, planów i podejść zarządczych.",
        "Sprzedaż gry na Steamie.",
        "Zamknięcie spółki."
      ],
      "correct": 1,
      "explanation": "Proces IP służy zbudowaniu solidnych fundamentów zarządczych zawartych w PID."
    },
    {
      "question": "4. W którym procesie Rada Projektu podejmuje kluczowe decyzje o zatwierdzeniu etapu, wyrażeniu zgody na IP oraz zatwierdzeniu PID?",
      "options": [
        "Directing a project (DP)",
        "Controlling a stage (CS)",
      ...
      "correct": 0,
      "explanation": "Directing a project (DP) to proces realizowany przez Radę Projektu trwający przez cały cykl życia."
    },
    {
      "question": "5. Co znajduje się w Planie Inicjowania Projektu (Initiation Stage Plan)?",
      "options": [
        "Plan prac i zasobów potrzebnych do przeprowadzenia samego procesu IP i stworzenia PID.",
        "Pełny kod źródłowy silnika 3D.",
        "Umowy ze wszystkimi graczami na świecie.",
        "Raport końcowy z zamknięcia."
      ],
      "correct": 0,
      "explanation": "Initiation Stage Plan tworzy się w SU, aby zaplanować budżet i czas na wykonanie samego etapu inicjowania (IP)."
    },
    {
      "question": "6. Jaka jest różnica między Zarysem Projektu (Project Brief) a PID?",
      "options": [
        "Project Brief to krótki wstęp z SU; PID to pełna, szczegółowa baza zarządcza powstała w IP.",
        "Nie ma różnicy.",
        "Project Brief tworzą programiści, a PID zarząd.",
        "PID zawiera tylko faktury."
      ],
      "correct": 0,
      "explanation": "Project Brief powstaje w SU jako zarys; na jego bazie w IP rozbudowuje się kompleksowy PID."
    }
  ],
  "examQuiz": [
    {
      "type": "standard",
      "question": "Jaki jest główny cel procesu Starting up a project (SU)?",
      "options": [
        "Dostarczenie gotowego produktu końcowego klientowi.",
        "Upewnienie się, że wstępne założenia projektu są spełnione oraz że istnieje uzasadnienie do rozpoczęcia procesu Inicjowania.",
        "Szczegółowe zaplanowanie wszystkich etapów realizacyjnych.",
        "Uroczyste świętowanie sukcesu rynkowego."
      ],
      "correct": 1,
      "explanation": "SU odpowiada na pytanie: 'Czy mamy wystarczająco dobry powód, by wydać pieniądze na inicjowanie projektu?'"
    },
    {
      "type": "missing-word",
      "question": "Uzupełnij poniższe zdanie:\nDokumentacja tworzona w procesie IP stanowiąca pojedyncze źródło prawdy o zarządzaniu projektem to [...].",
      "options": [
        "Project Brief",
    ...
    {
      "type": "negative",
      "question": "Które z działań NIE NALEŻY do procesu Initiating a project (IP)?",
      "options": [
        "Opracowanie Szczegółowego Uzasadnienia Biznesowego (Business Case).",
        "Stworzenie Podejść do Jakości, Ryzyka i Komunikacji.",
        "Pierwsze, wstępne zdefiniowanie ról przed decyzją o inicjowaniu (odbywa się w SU).",
        "Przygotowanie Planu Projektu (Project Plan)."
      ],
      "correct": 2,
      "explanation": "Wstępne obsadzenie ról i mianowanie PM odbywa się w SU, jeszcze przed rozpoczęciem IP."
    },
    {
      "type": "standard",
      "question": "Kto decyduje o przejściu z procesu SU do procesu IP (wyraża zgodę na inicjowanie)?",
      "options": [
        "Kierownik Projektu samodzielnie.",
        "Rada Projektu w procesie Directing a project (DP).",
        "Główny Programista.",
        "Zewnętrzna agencja reklamowa."
      ],
      "correct": 1,
      "explanation": "Decyzję o rozpoczęciu inicjowania podejmuje wyłącznie Rada Projektu w procesie DP."
    },
    {
      "type": "missing-word",
      "question": "Uzupełnij poniższe zdanie:\nProces, który trwa nieprzerwanie od rozpoczęcia projektu aż do jego zamknięcia i służy Radzie Projektu do podejmowania strategicznych decyzji, to Directing a [...].",
      "options": [
        "Stage",
        "Project (DP)",
        "Product",
  ...
  "flashcards": [
    {
      "q": "Jaka jest różnica w czasie między SU a IP?",
      "a": "SU to krótki proces przedprojektowy; IP to pierwszy pełny etap zarządczy (Inicjowanie)."
    },
    {
      "q": "Co jest głównym produktem procesu SU?",
      "a": "Project Brief (Zarys Projektu) oraz Plan Etapu Inicjowania."
    },
    {
      "q": "Co jest głównym produktem procesu IP?",
      "a": "PID (Dokumentacja Inicjująca Projekt)."
    },
    {
      "q": "Jaki proces odpowiada za podejmowanie decyzji przez Radę Projektu?",
      "a": "Directing a project (DP)."
    },
    {
      "q": "Ile etapów zarządczych musi posiadać projekt PRINCE2?",
      "a": "Minimum dwa: Etap Inicjowania oraz co najmniej jeden Etap Realizacyjny."
    },
    {
      "q": "Kto tworzy Zarys Projektu (Project Brief)?",
      "a": "Kierownik Projektu przy wsparciu Zleceniodawcy w procesie SU."
    },
    {
      "q": "Czy projekt może zakończyć się po procesie SU?",
      "a": "Tak, jeśli Rada Projektu uzna w procesie DP, że projekt nie ma zasadności biznesowej."
    },
    {
      "q": "Co zawiera PID?",
      "a": "Business Case, Plan Projektu, Podejścia zarządcze (Ryzyko, Jakość, Komunikacja), Struktury Ról."
    }
  ]
};
